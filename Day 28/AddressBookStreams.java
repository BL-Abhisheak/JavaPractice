...
import com.streams.AddressBookStr;
...
public class AddressBookStreams {
    ...
    static HashMap<String, AddressBookStreams> addressBook = new HashMap<>();
    static ArrayList<ContactsStr> contacts = new ArrayList<>();

    public AddressBookStreams(String name) {
    }

    public AddressBookStreams() {
    }
    ...
    public static void createAddressBook() {
        ...
        if (addressBook.containsKey(bookName)) {
            ...
            addressBook.put(bookName, new AddressBookStreams());
...
//                    break;
                ...
                case 2:
                    ...
                    if (!addressBook.containsKey(openBook)) {
                        ...
                        AddressBookStreams selected = addressBook.get(openBook);
